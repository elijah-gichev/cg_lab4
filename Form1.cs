...
namespace CompGraf4
{
    public partial class Form1 : Form
    {
        ...
        private void rotatePolygon_Click(object sender, EventArgs e)
        {
            if (curpol.Length == 0)
            {
                MessageBox.Show("Полигон не выбран");
        ...
        private void isInPolygon_Click(object sender, EventArgs e)
        {
            if (curpol.Length == 0)
            {
                MessageBox.Show("Полигон не выбран");
        ...
        private void dotRelativeLine_Click(object sender, EventArgs e)
        {
            if (curline2.Length == 0)
            {
